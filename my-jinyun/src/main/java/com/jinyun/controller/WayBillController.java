...
public class WayBillController {
    ...
    public Object queryWaybillByWaybillNumber(@PathVariable("waybillNumber")String waybillNumber){
        return this.wayBillService.queryWaybillByWaybillNumber(waybillNumber);
    }
